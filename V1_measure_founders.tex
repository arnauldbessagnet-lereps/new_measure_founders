...
The second reason related to the connection between start-up teams' skills endorsement diversity and their social capital. The literature demonstrates that the social capital of a start-up team has the capacity to act as control for information asymmetries. Indeed, \citet{huang2017resources, shane2002organizational} posit that the presence of a social connection between start-up teams and investors can reduce the informational gap between them. Specifically, \citet{shane2002network} infer that social capital play a role in connecting start-up teams to potential investors and facilitating fundraising. Additionally, \citet{hoenig2015quality} suggest that the social capital of a start-up team is utilized by investors to triangulate the quality of the firm and the composition of start-up teams and their relationships (alliances) are used as indicators of quality by investors \citep{plummer2016better, semrau2014exactly}. Following these rationales, if a start-up team's diversity of skills endorsements is the result of different social capital and given that capital influences the start-up teams' ability to raise funds from investors, start-up teams with diverse skills might therefore raise more funds than less diversed ones.

Thus, we hypothesize the following: \\

\noindent \textit{H2: Start-up teams with greater skills endorsement diversity will get more fundings from investors} \\

The past rationale invite us to think that having high both highly skilled individuals and a high levels of diversity within a start-up team is beneficial for firm performance. However past findings suggest that adding more human capital to a start-up team does not necessarily translate into greater success \citep{pierce2013too}. Indeed, theories suggest that diversity can hinder effective communication due to cognitive differences, evidence exists for a curvilinear relationship \citep{mathieu2000influence, nooteboom2007optimal}. Studies from high-tech firms in Italy, for example, have shown a curvilinear effect of industry expertise diversity \citep{sarto2022board}. This calls into question the universally positive relationship between diversity and performance, as extreme diversity can introduce additional costs related to communication and coordination.
...
\cmidrule(r){1-6}
\textbf{Independent variables} & & & & & \\
\textit{Skills level} & 514 & 7.862 & 1.647 & 0 & 9 \\
\textit{Skills field variety} & 514 & 0.603 & 0.367 & 0 & 1 \\
...
\scriptsize
    ...
    \toprule
        ...
        2 & Skills level & 0.180 & 1 & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ \\
        3 & Skills field variety & 0.023 & -0.257 & 1 & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ \\
...
\scriptsize
    \centering
    \caption{Results of OLS Regression for Signals and Investment Outcome. Log of funds received is the dependent variable of the OLS linear regression. "Skills level" score based on highest MEDIAN score}
    \begin{tabular}{llllll}
        ...
        Theorical & ~ & ~ & ~ & ~ & ~ \\
        & ~ & ~ & ~ & ~ & ~ \\
        Skill level (SL) & ~ & 0.287** & ~ & 0.322*** & 0.596*** \\
        ~ & ~ & (0.120) & ~ & (0.122) & (0.160) \\
        Skill field diversity (SFD) & ~ & ~ & 0.583 & 0.987 & 5.494*** \\
        ~ & ~ & ~ & (0.713) & (0.725) & (1.866) \\
...
\scriptsize
    \centering
    \caption{Results of OLS Regression for Signals and Investment Outcome. Log of funds received is the dependent variable of the OLS linear regression. "Skills level" score based on highest MAXIMUM score}
    \begin{tabular}{llllll}
      \toprule
        ~ & \textbf{Model 1} & \textbf{Model 2} & \textbf{Model 3} & \textbf{Model 4} & \textbf{Model 5} \\
        Variables & ~ & ~ & ~ & ~ & ~ \\
        ...
        Theorical & ~ & ~ & ~ & ~ & ~ \\
        & ~ & ~ & ~ & ~ & ~ \\
        Skill level (SL) & ~ & 0.456*** & ~ & 0.460*** & 0.657*** \\
        ~ & ~ & (0.163) & ~ & (0.164) & (0.190) \\
        Skill field diversity (SFD) & ~ & ~ & 0.583 & 0.647 & 3.493** \\
        ~ & ~ & ~ & (0.713) & (0.709) & (1.589) \\
...
\scriptsize
    \centering
    \caption{Results of OLS Regression for Signals and Investment Outcome. Log of funds received is the dependent variable of the OLS linear regression. "Skills level" score based on highest MEAN score}
    \begin{tabular}{llllll}
      \toprule
        ~ & \textbf{Model 1} & \textbf{Model 2} & \textbf{Model 3} & \textbf{Model 4} & \textbf{Model 5} \\
        Variables & ~ & ~ & ~ & ~ & ~ \\
        ...
        Theorical & ~ & ~ & ~ & ~ & ~ \\
        & ~ & ~ & ~ & ~ & ~ \\
        Skill level (SL) & ~ & 0.305** & ~ & 0.348** & 0.656*** \\
        ~ & ~ & (0.134) & ~ & (0.138) & (0.182) \\
        Skill field diversity (SFD) & ~ & ~ & 0.583 & 1.003 & 5.490*** \\
        ~ & ~ & ~ & (0.713) & (0.728) & (1.893) \\
